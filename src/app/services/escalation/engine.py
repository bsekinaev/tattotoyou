...
class EscalationEngine:
    """
    Движок принятия решений: нужен ли здесь живой человек (София).
    """
    ...
    ESCALATION_KEYWORDS = [
        "хочу софи", "позови софи", "зови софи",
        "позови мастер", "хочу мастер", "зови мастер",
        "ты бот", "ты туп", "ты не настоящ",
        "оператор", "связь с человек", "живой человек", "менеджер",
        "администратор", "руководств", "жалобн книг",
    ]
